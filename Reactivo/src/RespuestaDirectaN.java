 ...
 * @author ELI
 */
public class RespuestaDirectaN extends Reactivo{
    private String[] respuesta;
    private int[] ponderacion;
    public RespuestaDirectaN(String pre, String[] res, int[] pon) {
        super(pre, res, pon);
        respuesta=res;
        ponderacion=pon;
    ...
    public Double calificacion() {
        System.out.println("La calificación se obtiene al comparar las respuestas similar al la directa");
        return 0.0;
    }   
}
