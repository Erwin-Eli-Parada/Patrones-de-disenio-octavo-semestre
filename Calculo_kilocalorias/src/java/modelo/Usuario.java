...
@NamedQueries({
    ...
    , @NamedQuery(name = "Usuario.findByEstutura", query = "SELECT u FROM Usuario u WHERE u.estutura = :estutura")
...
public class Usuario implements Serializable {
    ...
    @Column(name = "ESTUTURA")
    private Double estutura;
    @Size(max = 50)
    ...
    public Double getEstutura() {
        return estutura;
    }

    public void setEstutura(Double estutura) {
        this.estutura = estutura;
    }
